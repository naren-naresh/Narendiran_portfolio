      ...
      <div className="mt-[1.5%] lg:grid grid-cols-2 gap-5">
        <div className="text-gray-500 text-sm md:text-base lg:text-base lg:w-full mt-[0.8%]">
          ...
          <div className='mt-[3%]'>
            ...
            <span className="text-gray-500 text-sm md:text-base lg:text-base lg:w-full mt-[0.2%] block">
              ...
              Currently, I’m working as a Software Developer at Wonder Worth Solutions, where I contribute to building robust and efficient applications while continuously expanding my expertise.........
      ...
      <div className="w-full mt-6">
        <div >
          <div  className="flex justify-between items-center transition-all duration-500  border-gray-200 px-1 py-3">
            ...
            <span className={`text-black font-medium text-sm md:text-base lg:text-base cursor-default  md:inline`}>Working Fulltime</span>
          </div>
        </div>
      </div>
